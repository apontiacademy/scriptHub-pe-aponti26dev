...
def main(config: Config):
    ...
    # 2. Garante que o diretório pai do arquivo de saída exista antes de rodar o Core
    if csv_saida:
        csv_saida.parent.mkdir(parents=True, exist_ok=True)

    # 3. Converte os objetos Path para str() ao montar a lista de argumentos para a CLI do Core
    argumentos_cli = []
