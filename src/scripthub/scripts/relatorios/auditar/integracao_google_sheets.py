...
def main(config: Config) -> None:
    ...
    try:
        ...
        try:
            ...
            raise ErroIntegracao(f"Falha ao ler o arquivo CSV local: {e}") from e
    ...
    try:
        ...
        raise ErroIntegracao(f"A aba '{nome_aba}' não foi encontrada na planilha fornecida.") from None
